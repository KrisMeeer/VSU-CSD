...
public class Main {
    ...
    public static SimpleColor getColor(double x, double y) {
        if ((circleLow.isPointDownOfCircle(x, y) && !verticalParabolaUp.isPointOfParabola(x, y) &&
                !verticalParabolaDown.isPointOfParabola(x, y)) || ((circleLarge.isPointDownOfCircle(x, y)) &&
                !circleLow.isPointDownOfCircle(x, y) && verticalParabolaDown.isPointOfParabola(x, y) &&
                !verticalParabolaUp.isPointOfParabola(x, y))) {
