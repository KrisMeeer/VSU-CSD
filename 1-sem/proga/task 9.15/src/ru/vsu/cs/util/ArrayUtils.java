...
public class ArrayUtils {
    ...
    public static ArrayList<Integer> toList(Integer[] arr) {
        if (arr == null) {
            return null;
        }
    ...
    public static ArrayList<Integer> toListArray(String str) {
    ...
    */
     ...
     */
    public static ArrayList<Integer> readIntArrayFromFile(String fileName) {
        try {
            return toListArray(readLinesFromFile(fileName)[0]);
        }
    ...
    public static void writeListToFile(String fileName, int[] arr, String itemFormat)
    ...
    public static void writeListToFile(String fileName, int[] arr)
            throws FileNotFoundException {
        writeListToFile(fileName, arr, null);
    }

    public static void writeListToFile(String fileName, double[] arr, String itemFormat)
            throws FileNotFoundException {
        try (PrintWriter out = new PrintWriter(fileName)) {
            out.println(toString(arr, itemFormat));
        }
    ...
    public static void writeListToFile(String fileName, ArrayList<Integer> arr2, double[] arr)
            throws FileNotFoundException {
        writeListToFile(fileName, arr, null);
    }

    public static void writeListToFile(String fileName, int[][] arr2, String itemFormat)
            throws FileNotFoundException {
        try (PrintWriter out = new PrintWriter(fileName)) {
    ...
    public static void writeListToFile(String fileName, int[][] arr2)
            throws FileNotFoundException {
        writeListToFile(fileName, arr2, null);
    }

    public static void writeListToFile(String fileName, double[][] arr2, String itemFormat)
            throws FileNotFoundException {
        try (PrintWriter out = new PrintWriter(fileName)) {
            out.println(toString(arr2, itemFormat));
        }
    ...
    public static void writeListToFile(String fileName, ArrayList<Integer> arr2)
            throws FileNotFoundException {
        writeListToFile(fileName, arr2, null);
    }
