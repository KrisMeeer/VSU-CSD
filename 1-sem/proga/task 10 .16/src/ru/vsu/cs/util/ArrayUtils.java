...
public class ArrayUtils {
    ...
    public static String[] toPrimitiveString(String[] arr) {
        if (arr == null) {
            return null;
        }
    ...
    public static String[] toStrArray(String str) {
        ...
        for (int i = 0; i < list.size(); i++) {
            if (i%4 == 0) {
                arr[number] = list.get(i) + " " + list.get(i + 1) + " " + list.get(i + 2) + " " + list.get(i + 3);
                number++;
            }
            }
        // Integer[] -> int[]
        return ArrayUtils.toPrimitiveString(arr);
    }
    ...
    */
    ...
    public static String[] readStringArrayFromFile(String fileName) {
        try {
            return toStrArray(readLinesFromFile(fileName)[0]);
        }
        catch(FileNotFoundException e) {
            return null;
        }
